      ...
      <div className="z-10 flex flex-col items-center text-center ">
        ...
        <div className="relative mx-5">
          <input name="text" type="text" required 
            className="rounded-md w-[350px] sm:w-[450px] md:w-[600px] lg:w-[700px] py-6  pl-18 mb-0  rounded-s-md pl-2 pr-12 focus:outline-none focus:ring-2 focus:ring-secHover"
